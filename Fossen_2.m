...
finAnle(i) = rudderAngle(i) + thetaP(i);
...
for i = 2:N
    ...
    heading_error = wrapToPi(planHeading - eta(3, i-1));
    ...
    R_rudder = [cos(rudderAngle(i)), -sin(rudderAngle(i));
                sin(rudderAngle(i)),  cos(rudderAngle(i))];
